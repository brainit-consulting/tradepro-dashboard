...
2. On your computer, create a folder (your current example folder is `H:\BrainITProjects\brainit-dashboard-project`).
...
- Rename your site: **Site configuration** -> **Change site name** (you renamed yours to `brainit-dashboard-project`)
